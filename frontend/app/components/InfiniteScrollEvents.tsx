      ...
      <div className="space-y-3">
        ...
        {hasMore && !isLoadingMore && events.length > 0 && (
          <div className="flex items-center justify-center py-2">
            <button
              onClick={loadMore}
              className="px-6 py-0 bg-[var(--app-accent)] text-foreground rounded-lg hover:bg-[var(--app-accent-hover)] transition-colors font-medium flex items-center gap-2 text-[12px] cursor-pointer"
            >
