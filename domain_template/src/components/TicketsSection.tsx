export default function TicketsSection() {
  ...
  return (
    <div className="bg-[#90EE90] py-8 sm:py-12 md:py-16 px-4 sm:px-6 md:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          {ticketPasses.map((pass, index) => (
            <div key={index} className="bg-white rounded-lg shadow-lg p-4 sm:p-6 md:p-8 relative">
              {/* Card Header */}
                ...
                <ul className="space-y-2 sm:space-y-3">
                  {pass.benefits.map((benefit, benefitIndex) => (
                    <li key={benefitIndex} className="flex items-start">
                      <span className="text-[#2C3E50] mr-2 sm:mr-3 mt-1">•</span>
              ...
              {pass.featured && (
                <div className="absolute bottom-4 sm:bottom-6 right-4 sm:right-6">
                  <button className="bg-[#FF8C00] hover:bg-[#E67E00] text-white font-bold py-2 sm:py-3 px-4 sm:px-6 rounded flex items-center space-x-2 transition-colors shadow-lg text-sm sm:text-base">
        ...
        <div className="text-center mt-8 sm:mt-10 md:mt-12">
          <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 md:p-8 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <button className="bg-[#6A28D7] hover:bg-[#5A1FA6] text-white font-bold py-3 sm:py-4 px-6 sm:px-8 rounded-lg transition-colors text-sm sm:text-base">
                View All Passes
              </button>
              <button className="bg-[#50C878] hover:bg-[#45B06A] text-white font-bold py-3 sm:py-4 px-6 sm:px-8 rounded-lg transition-colors text-sm sm:text-base">
                Contact Sales
              </button>
            </div>
          </div>
