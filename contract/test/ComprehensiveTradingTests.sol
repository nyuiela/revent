...
contract ComprehensiveTradingTests is BaseTradingTest {
    
    function testCompleteTradingSystemWithTokenization() public {
        ...
        console.log("Complete trading system with tokenization test passed!");
    }
    ...
    function testInvestorProtectionFlow() public {
        ...
        console.log("Investor protection flow test passed!");
    }

    function testDynamicPricingWithTradingMomentum() public {
        // 1. Create tokenized event
        eventId = createEventWithTokenization();
        ...
        console.log("Dynamic pricing with trading momentum test passed!");
    }

    function testOrderManagementFlow() public {
        // 1. Create tokenized event
        eventId = createEventWithTokenization();
        ...
        console.log("Order management flow test passed!");
    }

    function testStressTestMultipleEvents() public {
        ...
        console.log("Stress test with multiple events passed!");
    }
    ...
    function testGasOptimization() public {
        ...
        console.log("Event creation gas:", eventCreationGas);
        console.log("Pricing setup gas:", pricingGas);
        console.log("Investment gas:", investmentGas);
        console.log("Trading gas:", tradingGas);
    }
    ...
    function testComprehensiveMarketScenario() public {
        ...
        console.log("Comprehensive market scenario test passed!");
    }
}
