...
abstract contract TicketsV1 is ReentrancyGuardUpgradeable, AttendeesV1 {
    ...
    function purchaseTicket(
        ...
        emit TicketPurchased(ticketId, ticket.eventId, _msgSender(), quantity, totalPrice);
    }
    ...
    function updateTicket(
        ...
        require(ticketId > 0 && ticketId <= Counters.current(_ticketIds), "Invalid ticket ID");
        require(events[tickets[ticketId].eventId].creator == _msgSender(), "Not ticket creator");
