...
abstract contract ManagementV1 is StorageV1, EventModifiersV1, EventInternalUtilsV1 {
    ...
    function publishEvent(uint256 eventId) external eventExists(eventId) onlyEventCreator(eventId) {
        ...
        emit EventStatusChanged(eventId, oldStatus, EventTypes.EventStatus.PUBLISHED);
    }
    ...
    function startLiveEvent(uint256 eventId) public eventExists(eventId) {
        ...
        emit EventStatusChanged(eventId, oldStatus, EventTypes.EventStatus.LIVE);
    }
    ...
    function endEvent(uint256 eventId) external eventExists(eventId) onlyEventCreator(eventId) {
        ...
        emit EventStatusChanged(eventId, oldStatus, EventTypes.EventStatus.COMPLETED);
    }
