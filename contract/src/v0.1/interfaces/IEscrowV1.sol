...
interface IEscrowV1 {
    // Events
    event EscrowCreated(uint256 indexed eventId, address indexed creator, uint256 releaseTime);

    event FundsDeposited(uint256 indexed eventId, address indexed depositor, uint256 amount, uint256 totalDeposited);

    event FundsReleased(uint256 indexed eventId, address indexed creator, uint256 amount);

    event FundsRefunded(uint256 indexed eventId, address indexed creator, uint256 amount);

    event DisputeCreated(uint256 indexed eventId, address indexed creator, string reason);

    event DisputeResolved(uint256 indexed eventId, bool refund, address indexed resolver);
